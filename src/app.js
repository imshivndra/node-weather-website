...
app.get('/weather',(req,res)=>{
    ...
    geocode(req.query.address,(error,{latitude ,longitude,location}={})=>{
         if(error){
          ...
          forecast(latitude,longitude,(error,{temperature,region,place,country,precipitation,humidity,pressure,icon,weather_description,wind_speed})=>{
             if(error){
                     return res.send(error);
                                               }
                      res.send({temperature,region,place,location,country,precipitation,humidity,pressure,icon,weather_description,wind_speed
